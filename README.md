...
# 💫 About Me:
Hi there 👋<br>I am Pranav Suriya.<br><br>💻 Programmer Analyst @ Amazon<br>🎓 Electrical and Computer Engineering @ Amrita Vishwa Vidyapeetham University<br>🔭 I mostly work on web and android development .<br>⚙️ I daily use: `.cpp`, `.js`, `.html`, `.css` and `.py`. <br>💬 Ask me about anything related to open source, web, android and IOT .<br>I ❤️ to learn, code, play, and repeat.<br><br>To know more about me, view my portfolio here https://pranavsuriya.netlify.app/ .
